	...
	const nonProfits = [
		{
			name: "YOLA at HOLA",
			description:
				"Youth Orchestra of Los Angeles (YOLA) at Heart of Los Angeles (HOLA) classes include music creativity, singing and solfège, ensemble rehearsals, and an hour of academic tutoring daily. YOLA at HOLA is a partnership between the LA Phil and Heart of Los Angeles (HOLA).",
